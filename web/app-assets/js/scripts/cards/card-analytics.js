...
$(window).on('load', function () {
  ...
  var $appointmentChart = document.querySelector('#appointment-chart');
  ...
  appointmentChartOptions = {
    ...
    colors: [window.colors.solid.success, window.colors.solid.danger, window.colors.solid.warning, window.colors.solid.secondary, window.colors.solid.primary],
    stroke: {
      lineCap: 'round'
    },
    plotOptions: {
    ...
    series: [70, 39, 31, 23, 41],
    labels: ['Accepted', 'Rejected', 'In-Progress', 'Cancelled', 'Rescheduled']
  };
  appointmentChart = new ApexCharts($appointmentChart, appointmentChartOptions);
