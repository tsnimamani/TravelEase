      ...
      datasets: [
        {
          ...
          borderWidth: 1,
          label:"total booking",
          data: [100, 140, 50, 500, 350, 222, 321, 120, 320, 632, 400, 350]
        }
      ]
    }
  });
...
$(window).on('load', function () {
  ...
  var chart2 = document.querySelector('#chart2'),
    ...
    columnChartConfig = {
      ...
      colors: [chartColors.chart.green, chartColors.chart.red, chartColors.chart.grey, chartColors.chart.purple],
  ...
  if (typeof chart2 !== undefined && chart2 !== null) {
    ...
    var chart2 = new ApexCharts(chart2, columnChartConfig);
